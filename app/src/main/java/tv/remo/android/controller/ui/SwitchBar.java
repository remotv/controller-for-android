...
import tv.remo.android.settingsutil.views.ToggleSwitch;
...
public class SwitchBar extends LinearLayout implements CompoundButton.OnCheckedChangeListener {
    ...
    public void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        mSummarySpan = new TextAppearanceSpan(context, R.style.TextAppearance_AppCompat_Small);
        ...
        addOnSwitchChangeListener(
                new OnSwitchChangeListener() {
                    ...
                    public void onSwitchChanged(Switch switchView, boolean isChecked) {
                        SwitchBar.this.setTextViewLabelAndBackground(isChecked);
                    }
                });
    ...
    public void show() {
        if (!isShowing()) {
            ...
            post(new Runnable() {
                @Override
                public void run() {
                    SwitchBar.this.setTouchDelegate(
                            new TouchDelegate(new Rect(0, 0, SwitchBar.this.getWidth(), SwitchBar.this.getHeight()),
                                    SwitchBar.this.getDelegatingView()));
                }
            });
        }
    }
