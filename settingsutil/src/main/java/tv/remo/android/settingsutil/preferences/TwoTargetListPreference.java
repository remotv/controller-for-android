...
public class TwoTargetListPreference extends ListPreference {

    @TwoTargetPreferenceHelper.IconSize
    private int mIconSize;

    public TwoTargetListPreference(Context context, AttributeSet attrs,
                                   int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(context);
    }

    public TwoTargetListPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public TwoTargetListPreference(Context context) {
        super(context);
        init(context);
    }
